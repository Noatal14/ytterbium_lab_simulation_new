...
New runs should normally use ``simulations.zeeman``, ``simulations.mot_2d``,
and ``simulations.mot_3d`` directly. This module
...
from simulations.zeeman import run_and_save_zeeman, zeeman_simulation
